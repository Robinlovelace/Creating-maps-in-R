...
\makeatother
% \let\Oldincludegraphics\includegraphics[width=8cm][width=8cm][width=7cm][width=8cm][width=9cm]
% \renewcommand{\includegraphics[width=8cm][width=8cm][width=7cm][width=8cm][width=9cm]}[1]{\Oldincludegraphics[width=\maxwidth]{#1}}
\ifxetex
