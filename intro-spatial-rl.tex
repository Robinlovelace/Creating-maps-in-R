...
## [1] 33
\end{verbatim}
The dataset we will join to the London object is\ldots{}
...
using the \texttt{rgeos} package (see vignette of this on
...
\begin{figure}[htbp]
\centering
\includegraphics{figure/unnamed-chunk-201.png}
\caption{unnamed-chunk-20}
\end{figure}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{areas <- }\KeywordTok{sapply}\NormalTok{(stations.m@polygons, function(x) x@area)}
\KeywordTok{plot}\NormalTok{(stations.m$NUMBER, areas)}
\end{Highlighting}
\end{Shaded}
\begin{figure}[htbp]
\centering
\includegraphics{figure/unnamed-chunk-202.png}
\caption{unnamed-chunk-20}
\end{figure}
