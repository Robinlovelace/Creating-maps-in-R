...
To how each spatial data type can be visualised, the example datasets include at least on of each. To demonstrate how different datasets can be layered, they all have the same geographic extent (Greater London). Real data related to transport planning are used as an illustrative use-case of the visualisation methods. The datasets are as follows:
