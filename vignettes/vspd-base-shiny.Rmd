...
There is much to say about **leaflet** and it is an excellent package on which all other interactive mapping approaches covered in this tutorial (**tmap**, **mapview**, **shiny**) use. Rather than cover the material here, I suggest checking out and working-through the excellent online tutorial on **leaflet** at [rstudio.github.io/leaflet/](https://rstudio.github.io/leaflet/).
...
<!-- saveRDS(lnd_commutes, "vspd-data/l-lnd.Rds") -->
...
<!-- saveRDS(lnd_rnet, "vspd-data/rnet-lnd.Rds") -->
<!-- ``` -->
...
<!--                            Age_Band_of_Driver -->
<!--                            ) -->
<!-- saveRDS(lnd_crashes, "vspd-data/ac_cycle_lnd.Rds") -->
<!-- ``` -->
...
plot(lnd_topo)
points(killed)
saveRDS(lnd_topo, "vspd-data/lnd-topo.Rds")
```
