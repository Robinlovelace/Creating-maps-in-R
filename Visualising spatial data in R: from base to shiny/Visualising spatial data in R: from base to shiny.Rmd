...
title:
  formatted: "Visualising spatial data in R, from base to \\pkg{shiny}"
  # If you use tex in the formatted title, also supply version without
  plain:     "Visualising spatial data in R, from base to shiny"
  # For running headers, if needed
  short:     "Visualising spatial data in R"
abstract: >
