...
date: "V. 1.3, September 2015 --- see [github.com/Robinlovelace/Creating-maps-in-R](https://github.com/Robinlovelace/Creating-maps-in-R) for latest version"
output:
  pdf_document:
    fig_cap: yes
    fig_height: 3.5
...
- **ggplot2**: a popular and powerful visualisation package which links to **ggmap**
...
names(borough_dat)
borough_dat <- rename(borough_dat, conservative =
...
and **ggmap/ggplot2**. The focus is on
...
This section focusses primarily on **ggplot2**. More on **ggmap** 
can be found in the vignettes accompanying this tutorial:
https://github.com/Robinlovelace/Creating-maps-in-R/tree/master/vignettes
