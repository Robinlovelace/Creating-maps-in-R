...
```{r Preliminary plot of London with areas of high sports participation highlighted in blue}
plot(sport)
...
# It has an unusual encoding, hence the fileEncoding argument, usually unnecessary
