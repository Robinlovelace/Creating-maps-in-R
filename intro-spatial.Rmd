...
this can save you a lot of time in the long run, as
shown in figure x.

```{r}
lnd_sport@polygons[[1]]@Polygons[[1]]@coords
plot(lnd_sport@polygons[[1]]@Polygons[[1]]@coords)
```
...
leaflet() %>%
  addTiles() %>%
  addPolygons(data = lnd_sport_wgs84) 
...
object.size(lnd) / 1000

save(lnd, file = "~/Desktop/lnd.Rda")
```
