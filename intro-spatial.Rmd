...
crime_ag <- rename(crime_ag, name = Spatial_DistrictName)
...
Using this dataset and the methods developed above, Figure 4 was
...
clr <- as.character(factor(q,
  labels = paste0("grey", seq(from = 20, to = 80, by = 20))))
