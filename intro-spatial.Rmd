...
The above output tells us that `lnd` is a special spatial class,
...
the `lnd` object in the first instance, but we will give it a new name,
in case we ever need to re-use `lnd`.
