...
Using the above code as refrence try and find the remaining 3 quadrants and colour them the same as the map below.For bonus points try to desolve the quadrants so the map is left with only 4 polygons.  
