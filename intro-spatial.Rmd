...
author: "Robin Lovelace (R.Lovelace@leeds.ac.uk), James Cheshire and others"
...
R's 'base' graphics and use of the popular graphics package **ggplot2**. It teaches the basics of using R as a
...
4. Map making with **ggplot2**: a graphics package for producing beautiful maps quickly
...
Beyond visualisation and interogation GIS software must also
...
are fundamental operations in the GIS analyst's toolkit,
...
Each type of spatial data has a corrolary that can accepts
...
The above code extends the preexisting object `sp1` by adding
data from `df`. To see how strinct spatial classes are,
 ...
 * Kabacoff (2011): 'R in action' - more general R book with many fun worked examples.
