...
<qgis version="2.0.1-Dufour" minimumScale="-4.65661e-10" maximumScale="1e+08" minLabelScale="0" maxLabelScale="1e+08" hasScaleBasedVisibilityFlag="0" scaleBasedLabelVisibilityFlag="0">
  <renderer-v2 attr="" symbollevels="0" type="graduatedSymbol">
    <ranges/>
    <symbols/>
    <rotation field=""/>
  ...
  <edittypes>
    ...
    <edittype labelontop="0" editable="1" type="0" name="Partic_Per"/>
    <edittype labelontop="0" editable="1" type="0" name="PopDen"/>
    <edittype labelontop="0" editable="1" type="0" name="PopDensity"/>
    <edittype labelontop="0" editable="1" type="0" name="Pop_2001"/>
    <edittype labelontop="0" editable="1" type="0" name="name"/>
    <edittype labelontop="0" editable="1" type="0" name="ons_label"/>
  </edittypes>
  <editform></editform>
