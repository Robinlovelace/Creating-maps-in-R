...
\item
  ...
  ``Theft and Handling''.
\item
  the \texttt{\ensuremath{\sim}} symbol means ``by'': we aggregated the
...
\NormalTok{stations <- stations27700  }\CommentTok{# overwrite the stations object with stations27700}
...
the mean area of each borough with the mean value of stations within it:
