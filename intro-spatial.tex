...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{x <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"ggmap"}\NormalTok{, }\StringTok{"rgdal"}\NormalTok{, }\StringTok{"rgeos"}\NormalTok{, }\StringTok{"maptools"}\NormalTok{, }\StringTok{"dplyr"}\NormalTok{, }\StringTok{"tidyr"}\NormalTok{) }\CommentTok{# the packages}
\KeywordTok{install.packages}\NormalTok{(x) }\CommentTok{# warning: this may take a number of minutes}
...
\begin{figure}[htbp]
\centering
\includegraphics{./intro-spatial_files/figure-latex/unnamed-chunk-3-1.pdf}
...
\CommentTok{# Rename row 25 in crime_ag to match row 25 in lnd}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{head}\NormalTok{(lnd$name) }\CommentTok{# dataset to add to (results not shown)}
\KeywordTok{head}\NormalTok{(crime_ag$Borough) }\CommentTok{# the variables to join}
\NormalTok{crime_ag <-}\StringTok{ }\KeywordTok{rename}\NormalTok{(crime_ag, }\DataTypeTok{name =} \NormalTok{Borough) }\CommentTok{# rename the Borough heading}
\CommentTok{# head(join(lnd@data, crime_ag)) # test it works}
\NormalTok{lnd@data <-}\StringTok{ }\KeywordTok{left_join}\NormalTok{(lnd@data, crime_ag)}
\end{Highlighting}
\end{Shaded}
...
\begin{figure}[htbp]
\centering
\includegraphics{./intro-spatial_files/figure-latex/unnamed-chunk-40-1.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{./intro-spatial_files/figure-latex/unnamed-chunk-42-1.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{./intro-spatial_files/figure-latex/unnamed-chunk-47-1.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{./intro-spatial_files/figure-latex/unnamed-chunk-57-1.pdf}
\caption{Basemap 2}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics{./intro-spatial_files/figure-latex/unnamed-chunk-67-1.pdf}
