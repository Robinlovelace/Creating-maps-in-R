...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# rob00x-at-gmail-o-com}
\CommentTok{# ~~~___~~The future ~}
\CommentTok{# ~~/__/~|~~ is low ~}
\CommentTok{# ~/~~|~~|_ energy.~}
\CommentTok{# robinlovelace.net}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{#select rows from attribute slot of sport object, where sports participation is less than 15.}
\NormalTok{sport@data[sport$Partic_Per <}\StringTok{ }\DecValTok{15}\NormalTok{, ]}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{plot}\NormalTok{(sport[sport$Partic_Per >}\StringTok{ }\DecValTok{25}\NormalTok{, ]) }\CommentTok{# output not shown in tutorial}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{plot}\NormalTok{(sport[sport$Partic_Per >}\StringTok{ }\DecValTok{25}\NormalTok{,], }\DataTypeTok{col =} \StringTok{"blue"}\NormalTok{, }\DataTypeTok{add =} \OtherTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
with the attribute data in the `sport' object created above. Type:
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{Map <-}\StringTok{ }\KeywordTok{ggplot}\NormalTok{(sport.f, }\KeywordTok{aes}\NormalTok{(long, lat, }\DataTypeTok{group =} \NormalTok{group, }\DataTypeTok{fill =} \NormalTok{Partic_Per)) +}
\StringTok{  }\KeywordTok{geom_polygon}\NormalTok{() +}
\StringTok{  }\KeywordTok{coord_equal}\NormalTok{() +}
\StringTok{  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{x =} \StringTok{"Easting (m)"}\NormalTok{, }\DataTypeTok{y =} \StringTok{"Northing (m)"}\NormalTok{, }\DataTypeTok{fill =} \StringTok{"% Sport Partic."}\NormalTok{) +}
...
\NormalTok{sport.wgs84.f <-}\StringTok{ }\KeywordTok{merge}\NormalTok{(sport.wgs84.f, sport.wgs84@data,}
...
\begin{Highlighting}[]
\NormalTok{lnd.b1 +}
\StringTok{  }\KeywordTok{geom_polygon}\NormalTok{(}\DataTypeTok{data =} \NormalTok{sport.wgs84.f,}
