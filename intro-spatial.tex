...
`mirror', select one that is close to your home. If there is no output
...
you've not already \emph{installed} and loaded the package (as described
above for ggplot2) do so now:
