...
object called \texttt{crime\_data} to store this data.
...
\KeywordTok{summary}\NormalTok{(crime_data$MajorText) }\CommentTok{# summarise the column "MajorText"}
...
\KeywordTok{levels}\NormalTok{(crime_ag$Spatial_DistrictNam)}
\end{Highlighting}
\end{Shaded}
...
\begin{figure}[htbp]
\centering
\includegraphics{./intro-spatial_files/figure-latex/unnamed-chunk-33.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{./intro-spatial_files/figure-latex/unnamed-chunk-36.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{./intro-spatial_files/figure-latex/unnamed-chunk-38.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{./intro-spatial_files/figure-latex/unnamed-chunk-43.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{./intro-spatial_files/figure-latex/unnamed-chunk-53.pdf}
\caption{Basemap 2}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics{./intro-spatial_files/figure-latex/unnamed-chunk-63.pdf}
\caption{Faceted map}
\end{figure}
