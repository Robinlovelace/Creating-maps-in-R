...
- In R, packages **ggplot2** and **dplyr** have become immensly popular and now they are a part of the **tidyverse**
...
7. mention the raster package (it's not very tidyverse, however you can ajust it, for example using sfraster) + stars
8. one more time mention the book + encurage people to contribute
