...
etc associated with the shapefile. There are often a number of ways to do things 
in R - it is worth being aware of the alternatives.

A more powerful (and widely used) way to read in geographical data is to use the `rgdal` function 
